...
export default function AdminLogin() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <form
        action={action}
        className="w-full max-w-md bg-white rounded-2xl p-8 shadow-2xl space-y-5"
      >
        <div>
          ...
          <p className="text-sm text-slate-500 mt-2">
            Manage articles and consultation enquiries.
          </p>
        </div>
        ...
        <button
          disabled={pending}
          className="w-full rounded-lg bg-slate-900 py-3 font-bold text-amber-400 disabled:opacity-60"
        >
